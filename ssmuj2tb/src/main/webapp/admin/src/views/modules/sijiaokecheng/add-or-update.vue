<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="节数" prop="jieshu">
          <el-input v-model="ruleForm.jieshu" 
              placeholder="节数" clearable  :readonly="ro.jieshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="节数" prop="jieshu">
              <el-input v-model="ruleForm.jieshu" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="个人简介" prop="gerenjianjie">
          <el-input v-model="ruleForm.gerenjianjie" 
              placeholder="个人简介" clearable  :readonly="ro.gerenjianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="个人简介" prop="gerenjianjie">
              <el-input v-model="ruleForm.gerenjianjie" 
                placeholder="个人简介" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.dengji!=''&&json.dengji){
              		this.ruleForm.dengji = json.dengji
		}
		if(json.gerenjianjie!=''&&json.gerenjianjie){
              		this.ruleForm.gerenjianjie = json.gerenjianjie
		}
        } else {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `sijiaokecheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.sijiaokechengCrossAddOrUpdateFlag = false;
                  this.parent.search();

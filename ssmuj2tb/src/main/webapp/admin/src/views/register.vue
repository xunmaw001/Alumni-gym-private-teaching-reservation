  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(131, 138, 182, 1);fontSize:28px;">健身房私教预约小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiaolian'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.gerenjianjie" class="input" type="text" placeholder="个人简介">
			   </div>
			 </div> -->
			<el-form-item label="个人简介" class="input" v-if="tableName=='jiaolian'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='jiaolian'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201210/d55c814a470741d2a458550c0e81167d.jpg");
		height: 100vh;
